...
@WebServlet(name = "SVIncrementarDescargasOVisitas", urlPatterns = {"/SVIncrementarDescargasOVisitas"})
public class SVIncrementarDescargasOVisitas extends HttpServlet {
private class JsonData {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            preferenciasPort.incrementarDescargasOVisitasDeTema(idTema);
